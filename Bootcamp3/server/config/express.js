...
module.exports.init = function() {
  //connect to database // 'mongodb + srv://SantiUser:guitar2815@cluster0-q6gm1.mongodb.net/test?retryWrites=true&w=majority'
...
/* The next three middleware are important to the API that we are bulding */
  ...
  */
  app.use('/api/listings', listingsRouter);//MY CHANGE
  ...
  /* Request Handeler for all other routes
    ...
    app.all('/*', function (req, res) {
        ...
        */
        ...
        res.sendFile(path.resolve('/Users/santi/OneDrive/Documents/2019 Fall/Intro to Software Engineering/Bootcamp3/Bootcamp3_2019-master/Bootcamp3', './client/index.html'));
